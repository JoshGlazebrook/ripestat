...
const ENDPOINTS = {
  ...
  RIR_FIRST_LAST_SEEN: '/rir-first-last-seen/data.json{?resource,include}',
  RIR_PREFIXES: '/rir-prefixes/data.json{?resource,query_time,list_prefixes,types,af,noise}',
