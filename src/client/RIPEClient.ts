 ...
 */
   ...
   */
  rirASNS(options: data.RIRASNSOptions): Promise<RIPEResponse<data.RIRASNSResponse>> {
  ...
  routingHistory(options: data.RoutingHistoryOptions): Promise<RIPEResponse<data.RoutingHistoryResponse>> {
    return RIPEClient._performAPIRequest<data.RoutingHistoryOptions>(this.client, ENDPOINTS.ROUTING_HISTORY, options);
  }
